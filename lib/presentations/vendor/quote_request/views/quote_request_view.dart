...
class QuoteRequestView extends GetView<QuoteRequestController> {
  const QuoteRequestView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return GetBuilder<QuoteRequestController>(
        init: QuoteRequestController(),
        builder: (controller) {
          return Scaffold(
